...
<head>
    ...
    <meta name="description" content="Sistem Informasi Desa Sajira">
    <meta name="author" content="Pemerintah Desa Sajira">

    <title>SiDesa - Login Admin</title>
    ...
    <style>
        body {
            ...
            background: linear-gradient(-45deg, #0ea5e9, #3b82f6, #06b6d4, #14b8a6);
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-side">
                                <div class="bg-login-side-content">
                                    <h2 class="font-weight-bold mb-3">SiDesa Sajira</h2>
                                    <p class="mb-0">Mewujudkan tata kelola desa yang transparan, akuntabel, dan melayani dengan sepenuh hati menuju desa digital.</p>
                                </div>
                            </div>
                            <div class="col-lg-6 bg-white">
                                <div class="p-5">
                                    <div class="text-center mb-4">
                                        ...
                                        <h1 class="h4 text-gray-900 font-weight-bold fade-in-element delay-1">Selamat Datang!</h1>
                                        <p class="text-muted small fade-in-element delay-1">Silahkan login admin untuk melanjutkan</p>
                                    </div>
                                    ...
                                    <form class="user fade-in-element delay-2" action="{{ route('login.authenticate') }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <input type="email" name="email" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Masukan Email Address..." required value="{{ old('email') }}">
                                            @error('email')
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small pl-4">
