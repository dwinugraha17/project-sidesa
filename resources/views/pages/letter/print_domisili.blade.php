...
<head>
    ...
    <title>Cetak Surat - {{ $letter->resident->name }}</title>
    <style>
        /* Reset & Standardisasi Box Model untuk PDF agar tidak kepotong */
        * { box-sizing: border-box; }
        ...
        /* Tabel Data Penduduk - Pastikan tidak melebar */
        .table-data { 
            width: 100%; 
            margin: 10px 0; 
            border-collapse: collapse; 
            table-layout: fixed; /* Kunci lebar tabel agar tidak melar */
        }
        .table-data td { 
            vertical-align: top; 
            padding: 3px; 
            word-wrap: break-word; /* Paksa teks panjang turun ke bawah */
        }
...
<body>
    <div class="container">
        ...
        <table style="width: 100%; border-bottom: 4px double black; margin-bottom: 25px; padding-bottom: 10px;">
            <tr>
                <td style="width: 15%; vertical-align: middle; text-align: center;">
                    {{-- <img src="{{ public_path('Lebak.png') }}" alt="Logo" style="width: 80px; height: auto;"> --}}
                    <!-- Logo disembunyikan sementara karena GD Extension belum aktif -->
                </td>
        ...
        <div style="text-align: center; margin-bottom: 25px;">
            <h3 style="text-decoration: underline; margin-bottom: 2px;">SURAT KETERANGAN DOMISILI</h3>
            <span style="font-size: 14px;">Nomor: {{ $letter->letter_number }}</span>
        </div>

        <div class="content">
            <p class="no-indent">Yang bertanda tangan di bawah ini, Kepala Desa Sajira, Kecamatan Sajira, Kabupaten Lebak, Provinsi Banten, dengan ini menerangkan bahwa:</p>
            ...
            <table class="table-data">
                ...
                <tr>
                    <td>Agama</td>
                    <td>:</td>
                    <td>{{ $letter->resident->religion ?? '-' }}</td>
                </tr>
                <tr>
                    <td>Status Perkawinan</td>
                    <td>:</td>
                    <td>{{ ucfirst($letter->resident->marital_status) }}</td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>:</td>
            ...
            <p>Nama tersebut di atas adalah benar-benar warga Desa Sajira yang saat ini berdomisili di alamat tersebut di atas.</p>
        ...
        <!-- Tanda Tangan menggunakan Tabel 2 Kolom -->
        <table class="signature-table">
            <tr>
                <td width="50%">&nbsp;</td> <!-- Kolom kosong di kiri untuk mendorong tanda tangan ke kanan -->
                <td width="50%">
