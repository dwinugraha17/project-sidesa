...
<head>
    ...
    <title>Cetak SKTM - {{ $letter->resident->name }}</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div style="text-align: center; margin-bottom: 25px;">
            <h3 style="text-decoration: underline; margin-bottom: 2px;">SURAT KETERANGAN TIDAK MAMPU</h3>
        ...
        <div class="content">
            ...
            <p>Berdasarkan data dan pengamatan kami, nama tersebut di atas adalah benar warga Desa Sajira yang berasal dari keluarga ekonomi tidak mampu (Keluarga Prasejahtera).</p>
